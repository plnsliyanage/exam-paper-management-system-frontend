    ...
    >
      <div className="space-y-1.5">
        ...
        <p className="text-xs text-slate-400">
          Holder: {packet.currentHolderName || packet.currentHolder || "Not assigned"} | Deadline:{" "}
          {packet.deadline || "N/A"}
      ...
      <div className="flex items-center gap-2 self-end sm:self-center">
        <button
          ...
          title="View Details"
          className="p-2 hover:bg-[#7c4dff]/10 rounded-lg text-slate-500 hover:text-[#7c4dff] cursor-pointer"
        >
